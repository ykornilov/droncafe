module.exports = function(grunt) {
  ...
  var config = {
    ...
    compress: {
      ...
      src: {
        options: {
          archive: 'bin/materialize-app.zip',
          level: 6
        },
        files:[
          {expand: true, cwd: 'fonts/', src: ['**/*'], dest: 'materialize-app/fonts/'},
          {expand: true, cwd: 'sass/', src: ['materialize.scss'], dest: 'materialize-app/sass/'},
          {expand: true, cwd: 'sass/', src: ['components/**/*'], dest: 'materialize-app/sass/'},
          {expand: true, cwd: 'js/', src: [
            ...
            "carousel.js",
            "tapTarget.js",
          ], dest: 'materialize-app/js/'},
          {expand: true, cwd: 'dist/js/', src: ['**/*'], dest: 'materialize-app/js/bin/'},
          {expand: true, cwd: './', src: ['LICENSE', 'README.md'], dest: 'materialize-app/'}
    ...
    rename: {
      rename_src: {
        src: 'bin/materialize-app'+'.zip',
        dest: 'bin/materialize-app-v'+grunt.option( "newver" )+'.zip',
        options: {
          ignore: true
        }
      },
